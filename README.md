...
>
> **디자이너·대행사가 만든 HTML 시안을 그대로 옮길 분**이라면 → [`docs/mockup-to-pack.md`](docs/mockup-to-pack.md)
> (그 문서를 AI 에게 통째로 주면 됩니다. 시작점은 **콘솔에서 받은 시작 팩 zip** 이지 이 레포 클론이 아닙니다 —
> 여기 프리셋은 커머스 라우트를 다 갖고 있어 랜딩 한 장짜리 시안에는 과합니다).
>
