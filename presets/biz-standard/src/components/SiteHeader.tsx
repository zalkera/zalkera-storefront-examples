...
/**
 * 이 사이트의 헤더 — **`biz-standard` 의 것**(이 팩의 소스는 이 팩의 것이다 · 오너 확정 2026-08-01).
 *
 * 왜 다른가: 이 사이트는 상품·장바구니·주문 어느 것도 부르지 않는 소개 사이트라, 원본이 기본으로 주는
 * 장바구니·로그인 표면이 있으면 **사이트가 자기 정체를 잘못 말한다**.
