        ...
        <section className="mb-12 grid gap-6 md:grid-cols-2 md:items-center">
            {asset && (
                <img
                     ...
                     *   대역을 다투면 안 된다. 실측(shop-goods): 이 한 장이 홈 이미지
                     *   바이트의 **41%**(30,305/73,527 B)이고 히어로(§0)의 74% 다.
                     *   재현: `node -e 'for(const s of require("./content/pages/home.json").sections) console.log(s.type, s.config?.asset)'`
                     *   로 섹션별 자산을 뽑고 `ls -l public/` 로 바이트를 잰다.
